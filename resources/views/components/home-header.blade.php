    ...
    <div class="mx-auto w-full max-w-7xl lg:px-8">
        <div class="relative px-4 sm:px-8 lg:px-12">
            <div class="mx-auto max-w-2xl lg:max-w-5xl">
                <div>as;kldjsaklj</div>
                <div class="max-w-2xl">
                    <h1
                        class="text-4xl uppercase tracking-wide font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
                        {!! markdown(config('site.home.headline')) !!}
                    </h1>
                    <div class="mt-6 text-base text-zinc-600 dark:text-zinc-400 has-links">
                        {!! markdown(config('site.home.subheader')) !!}</div>
                    <div class="mt-6 flex gap-6"><a class="group -m-1 p-1" aria-label="Follow on X" target="_blank"
