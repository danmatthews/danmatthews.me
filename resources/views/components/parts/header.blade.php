                            ...
                            @if (!$avatar)
                                ...
                                <a aria-label="Home"
                                   ...
                                   style="transform:var(--avatar-image-transform)" href="/">
                                    <img
                                        src="{{ asset('images/avatar-small.jpg') }}"
                                        alt="{{ config('app.name') }}" fetchpriority="high" width="512" height="512"
                            ...
                            <div class="flex flex-1">
                                @if ($avatar)
                                    ...
                                    <div
                                        ...
                                        <a aria-label="Home" class="pointer-events-auto" href="/"><img alt=""
                                                                                                       fetchpriority="high"
                                                                                                       width="512"
                                                                                                       height="512"
                                                                                                       decoding="async"
                            ...
                            <div class="flex flex-1 justify-end md:justify-center">
                                <div class="pointer-events-auto md:hidden" data-headlessui-state="">
                                    <button
                                        ...
                                        id="headlessui-popover-button-:R5miqla:">Menu
                                        <svg viewBox="0 0 8 6"
                                             aria-hidden="true"
