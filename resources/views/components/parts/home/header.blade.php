    ...
    <div class="mx-auto w-full max-w-7xl lg:px-8">
        <div class="relative px-4 sm:px-8 lg:px-12">
            <div class="mx-auto max-w-2xl lg:max-w-5xl flex gap-6">
                {{-- <div
                    class="w-[16px] h-[220px] overflow-y-hidden flex flex-wrap border-t-[10px] border-b-[10px] border-[#FFA132]">
                    {!! pixels() !!}
                </div> --}}
                <div class="max-w-2xl">
                    <h1 class=" font-bold text-zinc-800 sm:text-6xl dark:text-zinc-100">
                        <span class="inline-block tracking-tighter pr-1 text-zinc-300 ">{!! markdown(config('site.home.headline')) !!}</span>
                    </h1>
                    <div class="mt-6 text-base text-white has-links">
                        {!! markdown(config('site.home.subheader')) !!}</div>
                    <div class="hidden mt-6 flex gap-6"><a class="group -m-1 p-1" aria-label="Follow on X" target="_blank"
