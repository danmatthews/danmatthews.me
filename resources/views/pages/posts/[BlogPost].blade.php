                    ...
                    <div class="xl:relative">
                        <div class="mx-auto max-w-2xl">
                            <a type="button" aria-label="Go back to articles" href="{{ url('posts') }}"
                                class="drop-shadow drop-shadow-[#ffa132]/50 filter-none group mb-8 flex h-10 w-10 items-center justify-center bg-[#FFA132]  shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 transition lg:absolute lg:-left-5 lg:-mt-2 lg:mb-0 xl:-top-1.5 xl:left-0 xl:mt-0  ">
