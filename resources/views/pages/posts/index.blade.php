            ...
            <div class="relative px-4 sm:px-8 lg:px-12">
                <div class="mx-auto max-w-2xl lg:max-w-5xl">
                    <header class="max-w-2xl"><h1
                            ...
                            {{ config('site.posts.headline') }}</h1>
                        <p class="mt-6 text-base text-zinc-600 dark:text-zinc-400">{{ config('site.posts.subheading') }}</p>
                    </header>
                                ...
                                @foreach ($posts as $post)
                                    <article class="md:grid md:grid-cols-4 md:items-baseline">
                                        <div class="md:col-span-3 group relative flex flex-col items-start">
                                            ...
                                            <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">{{ $post->excerpt }}</p>
