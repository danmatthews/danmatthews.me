            ...
            <div class="col-span-2">
                <div>
                    ...
                    <p class="">
                        Hey there, I’m Dan.</p>
                    <div
                        class="mt-6 space-y-7 text-base">
                        {!! markdown(config('site.about')) !!}
                    </div>

                </div>
                <h2 class="text-xl mt-16 mb-6 font-bold">Work History</h2>
                <div class="divide-y">
                ...
                <h2 class="text-xl mt-16 mb-6 font-bold">Socials</h2>
                <ul role="list">
                    <li class="flex"><a
                    ...
                    <li class="mt-4 flex"><a
                            class="group flex gap-2 items-center text-sm"
                    ...
                    <li class="mt-4 "><a
                            class="flex gap-2 items-center group text-sm"
