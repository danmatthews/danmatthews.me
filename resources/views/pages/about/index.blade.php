                ...
                <div class="mx-auto max-w-2xl lg:max-w-5xl">
                    <div class="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
                        ...
                        <div class="lg:order-first lg:row-span-2"><h1
                            ...
                            <div class="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400"><p>I’ve loved making
                                    things for as long as I can remember, and wrote my first program when I was 6 years
                                    old, just two weeks after my mom brought home the brand new Macintosh LC 550 that I
                                    taught myself to type on.</p>
                                <p>The only thing I loved more than computers as a kid was space. When I was 8, I
                                    ...
                                    enough that with just a bit of momentum I’d be able to get to orbit.</p>
                                <p>I spent the next few summers indoors working on a rocket design, while I recovered
                        ...
                        <div class="lg:pl-20">
                            <ul role="list">
                                <li class="flex"><a
                                        ...
                                        <span class="ml-4">Follow on X</span></a></li>
                                ...
                                <li class="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40 flex"><a
                                        ...
                                        <span class="ml-4">spencer@planetaria.tech</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
